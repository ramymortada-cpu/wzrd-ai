...
const DEFAULT_TEMPLATES = [
  {
    name: 'Welcome Email',
    nameAr: 'رسالة ترحيب',
    subject: 'Welcome to WZRD AI — Your 100 Credits Are Ready!',
    subjectAr: 'مرحباً في WZRD AI — ١٠٠ كريدت جاهزين!',
...
<h1 style="color:#4f46e5;font-size:24px">مرحباً في WZRD AI! 🎉</h1>
...
<p style="color:#94a3b8;font-size:13px;margin-top:24px">WZRD AI by Primo Marca</p>
</div>`,
  },
  {
    name: 'Tool Result',
