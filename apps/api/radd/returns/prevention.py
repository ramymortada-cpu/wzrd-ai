...
def _exchange_color_response(dialect: str, product: str) -> str:
    responses = {
        "gulf": "فهمتك! اللون مو اللي تبيه. ممكن نبدله بلون ثاني متوفر — بدون أي رسوم إضافية. وش اللون اللي تفضله؟",
        "egyptian": "فهمتك! اللون مش اللي انت عايزه. ممكن نبدلهولك بلون تاني متاح — من غير أي رسوم إضافية. إيه اللون اللي تحبه؟",
        "msa": "أفهمك. اللون غير مناسب. يمكننا استبداله بلون آخر متوفر بدون رسوم إضافية. أي لون تفضل؟",
    }
    return responses.get(dialect, responses["gulf"])
