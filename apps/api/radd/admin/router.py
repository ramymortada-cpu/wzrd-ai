...
async def get_benchmark(
    ...
    """Get cross-merchant benchmark comparison for this workspace's sector."""
...
async def get_upcoming_seasons(
    ...
    """Get upcoming seasons/holidays with KB preparation recommendations."""
    from radd.intelligence.seasonal_prep import get_upcoming_seasons
    ...
    alerts = get_upcoming_seasons(days_ahead=days_ahead, sector=sector)
    return {
        "seasons": [
            {
...
async def generate_seasonal_kb(
    ...
    """Generate and import seasonal KB content using AI."""
